...
const GstImageUpload = ({ callbackImage }) => {
    ...
    <Box>
      <Tooltip title="Gst No. Image ">
        ...
        >
          ...
          <span>Upload Photo Of GST(optional)</span>
        </Box>
      </Tooltip>
      <Box>
        <Modal
