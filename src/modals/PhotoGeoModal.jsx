...
const PhotoGeoModal = ({ callbackImage }) => {
  ...
  return (
    <Box>
      <Tooltip title="Photo With Geo Location">
        <Box
          sx={{
            width: "100%",
            height: "40px",
        ...
        >
          ...
          <span>Upload Photo With Geo Location</span>
        </Box>
      </Tooltip>
      <Box>
        <Modal
        ...
        >
          <Box sx={style} className="sm_modal">
            <ModalHeader title="Upload Photo With Geo Location" handleClose={handleClose} />
            <Box
              component="form"
              id="upload-image"
              validate
