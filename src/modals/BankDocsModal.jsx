...
const BankDocsModal = ({ callbackImage }) => {
  ...
  return (
    <Box>
      <Tooltip title="Upload Bank Docs">
        <Box
          sx={{
            width: "100%",
            height: "40px",
      ...
      <Box>
        ...
        >
          <Box sx={style} className="sm_modal">
            <ModalHeader
              title="Upload Cancel Cheque/Bank Statement/Passbook 1st Page"
