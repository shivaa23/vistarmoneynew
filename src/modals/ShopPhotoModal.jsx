...
const ShopPhotoModal = ({ callbackImage }) => {
  ...
  return (
    <Box>
      <Tooltip title="Shop Photo With Board and Geo Location">
        <Box
          sx={{
            width: "100%",
            height: "40px",
        ...
        >
          ...
          <span>Upload Shop Photo with Geo Location and Board</span>
        </Box>
      </Tooltip>
      <Box>
        <Modal
        ...
        >
          <Box sx={style} className="sm_modal">
            <ModalHeader title=" Upload Shop Image With Board" handleClose={handleClose} />
            <Box
              component="form"
              id="upload-image"
              validate
