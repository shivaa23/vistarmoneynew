...
const AepsTabs = ({
  ...
  const { getUserAxios } = useCommonContext();
  ...
  const { getRecentData, aepsType } = useCommonContext();
...
//   scanData,
// }) => {
//   const { getUserAxios, setOpenAeps2FAModal } = useCommonContext();
//   const [aadhaar, setAdhaar] = useState({
//     aadhaar: "",
//     numberformat: "1320",
//   });
...
//   const [amountInputVal, setAmountInputVal] = useState();
//   // 2fa scan data
//   const [outletscanData, setoutletScanData] = useState();
//   const [aepsApiCallforCustomerData, setAepsCallforCustomerData] =
//     useState(true);
...
//     if (aepsApiCallforCustomerData) {
//       console.log("here aeps data setter if condition");
//       // #########################################################
//       // AePS1 DATA PREPARATION ##################################
//       // #########################################################
//       if (aepsType === AEPS_TYPE.AEPS1) {
...
//       setAepsCallforCustomerData(false);
//       setOpenAeps2FAModal(true);
//     } else {
//       //  2fa login api call
//       console.log("here in 2fa api call");
//       if (outletscanData) {
//         let outletdata = {};
...
//             ci: outletscanData.cI,
//             dc: outletscanData.dC,
//             dpId: outletscanData.dpId,
//             errInfo: outletscanData?.errInfo,
//             fCount: outletscanData?.fCount,
//             mc: outletscanData?.mC,
//             mi: outletscanData?.mI,
//             nmPoints: outletscanData?.nmPoints,
//             pidData: outletscanData?.pidData,
//             pidDataType: outletscanData?.pidDataType,
//             qScore: outletscanData?.qScore,
//             rdsId: outletscanData?.rdsId,
//             rdsVer: outletscanData?.rdsVer,
//             sessionKey: outletscanData?.sessionKey,
//             srno: outletscanData?.srno,
//             hmac: outletscanData?.hMac,
//             sysId: outletscanData?.sysId,
//             latitude: userLat,
//             longitude: userLong,
//             pf: "WEB",
//           };
...
//             captureResponse: outletscanData,
//             deviceId: outletscanData.srno,
//             latitude: userLat,
//             longitude: userLong,
//           };
//         }
...
//             // now call the aeps all api's with the customer scanned data
//             postJsonData(
//               apiEnd && apiEnd !== "" ? apiEnd : null,
//               payload,
//               setRequest,
...
//     },
//     // eslint-disable-next-line react-hooks/exhaustive-deps
//     [scanData, aepsApiCallforCustomerData]
//   );
//   const validateFunc = (e) => {
//     e.preventDefault();
//   };
